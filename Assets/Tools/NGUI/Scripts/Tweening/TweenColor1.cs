...
public class TweenColor1 : UITweener
{
	...
	static public TweenColor1 Begin (GameObject go, float duration, Color color)
	{
#if UNITY_EDITOR
		if (!Application.isPlaying) return null;
#endif
		TweenColor1 comp = UITweener.Begin<TweenColor1>(go, duration);
