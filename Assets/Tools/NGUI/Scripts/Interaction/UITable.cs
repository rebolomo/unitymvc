...
public class UITable : UIWidgetContainer
{
	...
	public DirectionRow direction_row = DirectionRow.Left;
	...
	protected void RepositionVariableSize (List<Transform> children)
	{
		...
		//modified by tingli : 支持右侧对齐
		//TODO:代码有冗余，待优化
		if(direction_row == DirectionRow.Right)
		{
			//处理右对齐
...
//				ClientLogger.Info("========> " + b.extents.x + " " + b.extents.y);
//				ClientLogger.Info("========> " + b.center.x + " " + b.center.y);
//				ClientLogger.Info("========> " + b.min.x + " " + b.min.y);
