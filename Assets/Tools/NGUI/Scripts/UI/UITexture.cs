...
public class UITexture : UIWidget
{
	...
	public override void OnFill (BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		verts.Add(new Vector3(v.x, v.y));//bottom left
		verts.Add(new Vector3(v.x, v.w));//top    left
		verts.Add(new Vector3(v.z, v.w));//top    right
		verts.Add(new Vector3(v.z, v.y));//bottom right
